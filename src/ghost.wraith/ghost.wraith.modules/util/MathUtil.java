...
public class MathUtil implements Util {
    ...
    public static class_243 direction(float yaw) {
        return new class_243(Math.cos(degToRad((double)(yaw + 90.0F))), (double)0.0F, Math.sin(degToRad((double)(yaw + 90.0F))));
    }
    ...
    public static double degToRad(double deg) {
        return deg * (double)((float)Math.PI / 180F);
    }

    public static double getIncremental(double val, double inc) {
        double one = (double)1.0F / inc;
    ...
    public static double[] directionSpeed(double speed) {
        ...
        float yaw = mc.field_1724.field_5982 + (mc.field_1724.method_36454() - mc.field_1724.field_5982) * mc.method_60646().method_60637(false);
        if (forward != 0.0F) {
            if (side > 0.0F) {
    ...
    public static float[] calcAngle(class_243 from, class_243 to) {
        ...
        double difY = (to.field_1351 - from.field_1351) * (double)-1.0F;
        double difZ = to.field_1350 - from.field_1350;
        double dist = Math.sqrt(difX * difX + difZ * difZ);
        return new float[]{(float)class_3532.method_15338(Math.toDegrees(Math.atan2(difZ, difX)) - (double)90.0F), (float)class_3532.method_15338(Math.toDegrees(Math.atan2(difY, dist)))};
    }
}